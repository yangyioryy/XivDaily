...
data class SettingsUiState(
    ...
    val llmBaseUrl: String = "https://example.com/v1",
    val llmModel: String = "grok-4.20-0309-non-reasoning-console",
    ...
    val llmBaseUrlDraft: String = "https://example.com/v1",
    val llmApiKeyDraft: String = "",
    val llmModelDraft: String = "grok-4.20-0309-non-reasoning-console",
